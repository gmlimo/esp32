...
/* Pot */
#define Pot__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Pot__0__MASK 0x80u
#define Pot__0__PC CYREG_PRT1_PC7
#define Pot__0__PORT 1u
...
#define Pot__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
...
/* ack */
#define ack__0__INTTYPE CYREG_PICU2_INTTYPE1
#define ack__0__MASK 0x02u
#define ack__0__PC CYREG_PRT2_PC1
#define ack__0__PORT 2u
#define ack__0__SHIFT 1u
#define ack__AG CYREG_PRT2_AG
#define ack__AMUX CYREG_PRT2_AMUX
#define ack__BIE CYREG_PRT2_BIE
#define ack__BIT_MASK CYREG_PRT2_BIT_MASK
#define ack__BYP CYREG_PRT2_BYP
#define ack__CTL CYREG_PRT2_CTL
#define ack__DM0 CYREG_PRT2_DM0
#define ack__DM1 CYREG_PRT2_DM1
#define ack__DM2 CYREG_PRT2_DM2
#define ack__DR CYREG_PRT2_DR
#define ack__INP_DIS CYREG_PRT2_INP_DIS
#define ack__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define ack__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define ack__LCD_EN CYREG_PRT2_LCD_EN
#define ack__MASK 0x02u
#define ack__PORT 2u
#define ack__PRT CYREG_PRT2_PRT
#define ack__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define ack__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define ack__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define ack__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define ack__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define ack__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define ack__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define ack__PS CYREG_PRT2_PS
#define ack__SHIFT 1u
#define ack__SLW CYREG_PRT2_SLW
...
/* no_rx */
#define no_rx__0__INTTYPE CYREG_PICU2_INTTYPE2
#define no_rx__0__MASK 0x04u
#define no_rx__0__PC CYREG_PRT2_PC2
#define no_rx__0__PORT 2u
#define no_rx__0__SHIFT 2u
#define no_rx__AG CYREG_PRT2_AG
#define no_rx__AMUX CYREG_PRT2_AMUX
#define no_rx__BIE CYREG_PRT2_BIE
#define no_rx__BIT_MASK CYREG_PRT2_BIT_MASK
#define no_rx__BYP CYREG_PRT2_BYP
#define no_rx__CTL CYREG_PRT2_CTL
#define no_rx__DM0 CYREG_PRT2_DM0
#define no_rx__DM1 CYREG_PRT2_DM1
#define no_rx__DM2 CYREG_PRT2_DM2
#define no_rx__DR CYREG_PRT2_DR
#define no_rx__INP_DIS CYREG_PRT2_INP_DIS
#define no_rx__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define no_rx__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define no_rx__LCD_EN CYREG_PRT2_LCD_EN
#define no_rx__MASK 0x04u
#define no_rx__PORT 2u
#define no_rx__PRT CYREG_PRT2_PRT
#define no_rx__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define no_rx__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define no_rx__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define no_rx__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define no_rx__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define no_rx__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define no_rx__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define no_rx__PS CYREG_PRT2_PS
#define no_rx__SHIFT 2u
#define no_rx__SLW CYREG_PRT2_SLW

/* DInput */
#define DInput__0__INTTYPE CYREG_PICU3_INTTYPE0
#define DInput__0__MASK 0x01u
#define DInput__0__PC CYREG_PRT3_PC0
#define DInput__0__PORT 3u
#define DInput__0__SHIFT 0u
#define DInput__1__INTTYPE CYREG_PICU3_INTTYPE1
#define DInput__1__MASK 0x02u
#define DInput__1__PC CYREG_PRT3_PC1
#define DInput__1__PORT 3u
#define DInput__1__SHIFT 1u
#define DInput__2__INTTYPE CYREG_PICU3_INTTYPE2
#define DInput__2__MASK 0x04u
#define DInput__2__PC CYREG_PRT3_PC2
#define DInput__2__PORT 3u
#define DInput__2__SHIFT 2u
#define DInput__3__INTTYPE CYREG_PICU3_INTTYPE3
#define DInput__3__MASK 0x08u
#define DInput__3__PC CYREG_PRT3_PC3
#define DInput__3__PORT 3u
#define DInput__3__SHIFT 3u
#define DInput__AG CYREG_PRT3_AG
#define DInput__AMUX CYREG_PRT3_AMUX
#define DInput__BIE CYREG_PRT3_BIE
#define DInput__BIT_MASK CYREG_PRT3_BIT_MASK
#define DInput__BYP CYREG_PRT3_BYP
#define DInput__CTL CYREG_PRT3_CTL
#define DInput__DM0 CYREG_PRT3_DM0
#define DInput__DM1 CYREG_PRT3_DM1
#define DInput__DM2 CYREG_PRT3_DM2
#define DInput__DR CYREG_PRT3_DR
#define DInput__INP_DIS CYREG_PRT3_INP_DIS
#define DInput__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define DInput__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define DInput__LCD_EN CYREG_PRT3_LCD_EN
#define DInput__MASK 0x0Fu
#define DInput__PORT 3u
#define DInput__PRT CYREG_PRT3_PRT
#define DInput__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define DInput__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define DInput__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define DInput__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define DInput__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define DInput__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define DInput__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define DInput__PS CYREG_PRT3_PS
#define DInput__SHIFT 0u
#define DInput__SLW CYREG_PRT3_SLW

/* DOutput */
#define DOutput__0__INTTYPE CYREG_PICU3_INTTYPE4
#define DOutput__0__MASK 0x10u
#define DOutput__0__PC CYREG_PRT3_PC4
#define DOutput__0__PORT 3u
#define DOutput__0__SHIFT 4u
#define DOutput__1__INTTYPE CYREG_PICU3_INTTYPE5
#define DOutput__1__MASK 0x20u
#define DOutput__1__PC CYREG_PRT3_PC5
#define DOutput__1__PORT 3u
#define DOutput__1__SHIFT 5u
#define DOutput__2__INTTYPE CYREG_PICU3_INTTYPE6
#define DOutput__2__MASK 0x40u
#define DOutput__2__PC CYREG_PRT3_PC6
#define DOutput__2__PORT 3u
#define DOutput__2__SHIFT 6u
#define DOutput__3__INTTYPE CYREG_PICU3_INTTYPE7
#define DOutput__3__MASK 0x80u
#define DOutput__3__PC CYREG_PRT3_PC7
#define DOutput__3__PORT 3u
#define DOutput__3__SHIFT 7u
#define DOutput__AG CYREG_PRT3_AG
#define DOutput__AMUX CYREG_PRT3_AMUX
#define DOutput__BIE CYREG_PRT3_BIE
#define DOutput__BIT_MASK CYREG_PRT3_BIT_MASK
#define DOutput__BYP CYREG_PRT3_BYP
#define DOutput__CTL CYREG_PRT3_CTL
#define DOutput__DM0 CYREG_PRT3_DM0
#define DOutput__DM1 CYREG_PRT3_DM1
#define DOutput__DM2 CYREG_PRT3_DM2
#define DOutput__DR CYREG_PRT3_DR
#define DOutput__INP_DIS CYREG_PRT3_INP_DIS
#define DOutput__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define DOutput__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define DOutput__LCD_EN CYREG_PRT3_LCD_EN
#define DOutput__MASK 0xF0u
#define DOutput__PORT 3u
#define DOutput__PRT CYREG_PRT3_PRT
#define DOutput__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define DOutput__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define DOutput__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define DOutput__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define DOutput__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define DOutput__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define DOutput__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define DOutput__PS CYREG_PRT3_PS
#define DOutput__SHIFT 4u
#define DOutput__SLW CYREG_PRT3_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "Analog Read"
