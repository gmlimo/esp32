// ======================================================================
// Analog Read.v generated from TopDesign.cysch
// 01/18/2024 at 15:06
...
`ifdef WARP
`define CY_BLK_DIR "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50"
`include "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50\B_UART_v2_50.v"
`else
`define CY_BLK_DIR "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50"
`include "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50\B_UART_v2_50.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0"
`include "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`else
`define CY_BLK_DIR "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0"
`include "D:\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`endif
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("ce66a179-6498-46ca-8153-429cbc09f0ae/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__ack_net;
	wire [0:0] tmpFB_0__ack_net;
	wire [0:0] tmpIO_0__ack_net;
	wire [0:0] tmpINTERRUPT_0__ack_net;
	electrical [0:0] tmpSIOVREF__ack_net;

	cy_psoc3_pins_v1_10
		#(.id("67b76396-745b-478b-b07a-4f901512c424"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ack
		 (.oe(tmpOE__ack_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ack_net[0:0]}),
		  .io({tmpIO_0__ack_net[0:0]}),
		  .siovref(tmpSIOVREF__ack_net),
		  .interrupt({tmpINTERRUPT_0__ack_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ack_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [3:0] tmpOE__DInput_net;
	wire [3:0] tmpFB_3__DInput_net;
	wire [3:0] tmpIO_3__DInput_net;
	wire [0:0] tmpINTERRUPT_0__DInput_net;
	electrical [0:0] tmpSIOVREF__DInput_net;
	...
	cy_psoc3_pins_v1_10
		...
		DInput
		 (.oe(tmpOE__DInput_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__DInput_net[3:0]}),
		  .io({tmpIO_3__DInput_net[3:0]}),
		  .siovref(tmpSIOVREF__DInput_net),
		  .interrupt({tmpINTERRUPT_0__DInput_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

	wire [3:0] tmpOE__DOutput_net;
	wire [3:0] tmpFB_3__DOutput_net;
	wire [3:0] tmpIO_3__DOutput_net;
	wire [0:0] tmpINTERRUPT_0__DOutput_net;
	electrical [0:0] tmpSIOVREF__DOutput_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		DOutput
		 (.oe(tmpOE__DOutput_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__DOutput_net[3:0]}),
		  .io({tmpIO_3__DOutput_net[3:0]}),
		  .siovref(tmpSIOVREF__DOutput_net),
		  .interrupt({tmpINTERRUPT_0__DOutput_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DOutput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

	wire [0:0] tmpOE__no_rx_net;
	wire [0:0] tmpFB_0__no_rx_net;
	wire [0:0] tmpIO_0__no_rx_net;
	wire [0:0] tmpINTERRUPT_0__no_rx_net;
	electrical [0:0] tmpSIOVREF__no_rx_net;

	cy_psoc3_pins_v1_10
		#(.id("2add6e58-04b7-43eb-b2da-a76b58891c92"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		no_rx
		 (.oe(tmpOE__no_rx_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__no_rx_net[0:0]}),
		  .io({tmpIO_0__no_rx_net[0:0]}),
		  .siovref(tmpSIOVREF__no_rx_net),
		  .interrupt({tmpINTERRUPT_0__no_rx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__no_rx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
